...
public class Cyclist {
    ...
    // caratteristiche (charac + limit)
    private final Integer charPlain;
    private final Integer limitPlain;

    private final Integer charMountain;
    private final Integer limitMountain;

    private final Integer charMediumMountain;
    private final Integer limitMediumMountain;

    private final Integer charDownhilling;
    private final Integer limitDownhilling;

    private final Integer charCobble;
    private final Integer limitCobble;

    private final Integer charTimeTrial;
    private final Integer limitTimeTrial;

    private final Integer charPrologue;
    private final Integer limitPrologue;

    private final Integer charSprint;
    private final Integer limitSprint;

    private final Integer charAcceleration;
    private final Integer limitAcceleration;

    private final Integer charEndurance;
    private final Integer limitEndurance;

    private final Integer charResistance;
    private final Integer limitResistance;

    private final Integer charRecuperation;
    private final Integer limitRecuperation;

    private final Integer charHill;
    private final Integer limitHill;

    private final Integer charBaroudeur;
    private final Integer limitBaroudeur;
    ...
    public Cyclist(
        ...
        this.charPlain = charPlain;
        this.limitPlain = limitPlain;
        this.charMountain = charMountain;
        this.limitMountain = limitMountain;
        this.charMediumMountain = charMediumMountain;
        this.limitMediumMountain = limitMediumMountain;
        this.charDownhilling = charDownhilling;
        this.limitDownhilling = limitDownhilling;
        this.charCobble = charCobble;
        this.limitCobble = limitCobble;
        this.charTimeTrial = charTimeTrial;
        this.limitTimeTrial = limitTimeTrial;
        this.charPrologue = charPrologue;
        this.limitPrologue = limitPrologue;
        this.charSprint = charSprint;
        this.limitSprint = limitSprint;
        this.charAcceleration = charAcceleration;
        this.limitAcceleration = limitAcceleration;
        this.charEndurance = charEndurance;
        this.limitEndurance = limitEndurance;
        this.charResistance = charResistance;
        this.limitResistance = limitResistance;
        this.charRecuperation = charRecuperation;
        this.limitRecuperation = limitRecuperation;
        this.charHill = charHill;
        this.limitHill = limitHill;
        this.charBaroudeur = charBaroudeur;
        this.limitBaroudeur = limitBaroudeur;
    }
